...
namespace DSPComponentsUnitTest
{
    ...
    public class SinCosTestCases
    {
        ...
        public void SinCosTestMethod1()
        {
            ...
            var expectedOutput = UnitTestUtitlities.LoadSignal(@"F:\unversity\level4_subject\DSP\Lap1\Package and Task\fcisdsp-dsp.toolbox-78ddd969882b\DSPToolbox\DSPComponentsUnitTest\TestingSignals\Sin.ds");
        ...
        public void SinCosTestMethod2()
        {
            ...
            obj.Run();
            var expectedOutput = UnitTestUtitlities.LoadSignal(@"F:\unversity\level4_subject\DSP\Lap1\Package and Task\fcisdsp-dsp.toolbox-78ddd969882b\DSPToolbox\DSPComponentsUnitTest\TestingSignals\Cos.ds");
            Assert.IsTrue(UnitTestUtitlities.SignalsSamplesAreEqual(expectedOutput.Samples, obj.samples));
